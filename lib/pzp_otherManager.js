...
var PzpOtherManager = function () {
     ...
     */
    this.messageHandlerRegistration = function(pzhId) {
        ...
        if (PzpObject.getConnectedPzh().hasOwnProperty(pzhId) && PzpObject.getEnrolledStatus()) {
            var msg = PzpObject.messageHandler.createRegisterMessage(PzpObject.getSessionId(), pzhId);
    ...
    this.initializeRPC_Message = function () {
        ...
        serviceManagement = new PzpCommon.serviceManagement(rpcHandler, [registry]);
        registry.registerObject (serviceManagement);
