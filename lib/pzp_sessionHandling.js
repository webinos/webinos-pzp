...
function Pzp(inputConfig) {
    ...
    this.getPzhConnectedDevices = function(id) {
        return (id ? Object.keys(pzpState.connectedDevicesToPzh[id]): pzpState.connectedDevicesToPzh);
    };
    ...
    this.getConnectedDevices = function() {
        pzpState.connectedDevicesToPzh.pzp.sort(function(a,b) {return ((a.id)> ( b.id) ? 1 : ((b.id) > (a.id)) ? -1 : 0);} );
        pzpState.connectedDevicesToPzh.pzh.sort(function(a,b) {return ((a.id)> ( b.id) ? 1 : ((b.id) > (a.id)) ? -1 : 0);} );
