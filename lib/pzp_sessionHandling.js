...
function Pzp(inputConfig) {
    ...
    this.getConnectedPzp        = function() { return pzpState && Object.keys(pzpState.connectedPzp); };
    this.getConnectedPzh        = function() { return pzpState && Object.keys(pzpState.connectedPzh); };
    ...
    // Checks if component is currently connected
    ...
    this.setPzhId = function (id) { config.metaData.pzhId =  id; };
    this.setExternalCertificate = function(value){config.exCertList.exPZP = value;};
    ...
    /**
     * Handles peer pzp authentication..
    ...
    this.handlePeerAuthorization = function(clientSessionId, conn) {
        ...
        var msg = PzpObject.messageHandler.createRegisterMessage(PzpObject.getSessionId(), clientSessionId);
