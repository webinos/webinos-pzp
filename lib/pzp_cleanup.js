        ...
        if (_id) {
            ...
            if(PzpObject.getConnectedPzp(_id)){
                ...
                if (PzpObject.getConnectedPzp().length <= 1) {
                    ...
                    PzpObject.updateState("Pzp", "not connected");
                    PzpObject.updatePzhConnectedDevices("pzp", []);
                }
            ...
            if (PzpObject.getConnectedPzh(_id)) {
                ...
                PzpObject.updateState("Pzh", "not connected");
                PzpObject.updatePzhConnectedDevices("pzh", []);
                PzpObject.updatePzhConnectedDevices("pzp", []);
                PzpObject.deleteConnectedDevice(_id);
            }
...
//            }
    ...
    this.unRegisterDevice = function() {
        ...
        PzpObject.cancelPzhConnectorTimer();
